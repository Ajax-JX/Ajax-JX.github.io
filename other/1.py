...
def delete_file(filename):
    info_url = "https://github.com/Ajax-JX/Ajax-JX.github.io/delete/main/other/title"
    a = get_info(info_url)
    if a is None:
...
class GitHubFileManager(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("GitHub File Manager")
        ...
        self.delete_button = tk.Button(self, text="Delete", command=self.delete_selected_file)
    ...
    def upload_file(self):
        ...
        if file_path:
            ...
            if response and "success" in response:
                messagebox.showinfo("Success", f"{filename} has been uploaded.")
